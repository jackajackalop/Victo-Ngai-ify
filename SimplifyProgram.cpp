...
SimplifyProgram::SimplifyProgram() {
	...
	,
        ...
        "vec4 ctrl_line_color = vec4(0, 0, 0, 0); \n"
        "vec4 transp_line_color = vec4(0, 0, 0, 0); \n"
        ...
        "       transp_line_color = texelFetch(transp_color_tex, c+ivec2(1, -1), lod); \n"
        "       ctrl_line_color = texelFetch(line_color_tex, c+ivec2(1, -1), lod); \n"
        "   } else if(mind == d1) {\n "
        "       line_color = texelFetch(color_tex, c+ivec2(1, 1), lod); \n"
        "       transp_line_color = texelFetch(transp_color_tex, c+ivec2(1, 1), lod); \n"
        "       ctrl_line_color = texelFetch(line_color_tex, c+ivec2(1, 1), lod); \n"
        ...
        "       if(transp_line_color.a>0) line_color = transp_line_color; \n"
