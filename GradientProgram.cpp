...
GradientProgram::GradientProgram() {
	...
	,
        ...
        "   vec3 eqG = calculate_eq(0); \n"
        "   vec3 eqB = calculate_eq(0); \n"
        ...
        "   color.r = color.r*gradient_valR; \n"
        "   color.g = color.g*gradient_valG; \n"
        "   color.b = color.b*gradient_valB; \n"
        "   gradient_out = vec4(color.rgb, 1.0); \n"
